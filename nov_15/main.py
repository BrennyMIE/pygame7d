...
seed_x = 890524 # random.randint(0, 1000000) - permanent seed during testing - guaranteed completable
seed_y = 934885 # random.randint(0, 1000000) - permanent seed during testing - guaranteed completable
print({seed_x, seed_y})
...
# --- Begin Update Loop ---
    ...
    if generated_world_edge_x - world_scroll <= renderzone_right:
        ...
        new_ground = pygame.Rect(generated_world_edge_x,y_pos+tile_height,tile_width, tile_height)
        ground_rects.append(new_ground)
        generated_world_edge_x += tile_width
...
# --- Begin Draw Loop ---
    ...
    for ground in ground_rects:
        ...
        elif not has_above and not has_right: #topright
            texture_to_draw = ground_texture_topright
        elif not has_below and not has_left: #botleft
            texture_to_draw = ground_texture_botleft
        elif not has_below and not has_right: # botright
            texture_to_draw = ground_texture_botright
        
        #edges
        elif not has_above and has_left and has_right and has_below: # top edge
            texture_to_draw = ground_texture_topmid
        elif not has_below and has_left and has_right and has_above: # bottom edge
            texture_to_draw = ground_texture_botmid
        elif not has_left and has_above and has_below and has_right: # left edge
            texture_to_draw = ground_texture_midleft
        elif not has_right and has_left and has_below and has_above: # right edge
            texture_to_draw = ground_texture_midright
        
        #middlemiddle
        elif has_above and has_right and has_below and has_left:
